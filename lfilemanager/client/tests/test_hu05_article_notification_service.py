...
class TestHU05ArticleNotificationService:
    """Pruebas automatizadas para HU-05: Notificar a los usuarios sobre
    cambios en un artículo legal."""
    ...
    # TC-21: Equivalence Partitioning / Happy Path - Modificar artículo
    ...
    def test_update_article_automatically_creates_global_notification(self):
        ...
        assert notif.oid_usuario is None  # Es una notificación global para los usuarios  # noqa: E501

    # TC-22: Decision Table - Usuarios regulares consultan
    # notificaciones de cambio de artículo
    ...
    # TC-23: Boundary Value Analysis / Security - Intento de
    # actualización sin autenticación rebotado
    ...
    # TC-24: White-Box Path Testing - Verificación de no
    # duplicidad excesiva en notificaciones
    def test_partial_update_article_triggers_notification_with_updated_metadata(self):  # noqa: E501
        self.client.force_authenticate(user=self.admin)
        url = reverse("codigo-legal-detail", args=[self.articulo.oid_codigo])
        ...
        assert self.articulo.texto_contenido == "Actualización parcial de contenido"  # noqa: E501
    ...
    def test_receive_notifications_of_changes_in_article_triggers_alert(self):
        ...
        TC-31: Valida que la actualización de un artículo
        genere automáticamente un registro de notificación en el sistema.
        """
        ...
        # Autenticar usando el usuario configurado
        # en el setup_method de la clase
        usuario = getattr(
            self, "lawyer_1", getattr(self, "user", getattr(self, "admin", None))  # noqa: E501
        )
        if usuario:
        ...
        # 4. Validar que la respuesta sea 200 OK y
        # que se haya creado la notificación en BD
        assert response.status_code == status.HTTP_200_OK
