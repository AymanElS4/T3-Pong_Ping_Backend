...
def backfill_fecha_publicada(apps, schema_editor):
    ...
    CodigoLegal.objects.filter(fecha_publicada__isnull=True).update(fecha_publicada=default)
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(backfill_fecha_publicada, reverse_code=migrations.RunPython.noop),
